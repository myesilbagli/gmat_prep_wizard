  ...
  return (
    <div className="container" style={{ paddingBottom: 18 }}>
      <div style={{ marginBottom: 12 }}>
        <h2 style={{ margin: 0, fontSize: 20 }}>Test</h2>
        <div className="muted" style={{ fontSize: 13 }}>
          Quiz yourself on your saved items.
        </div>
      </div>
      ...
      >
        ...
        {loadError && (
          <div style={{ color: 'var(--danger)', fontSize: 13 }}>{loadError}</div>
        )}
        {quizError && (
          <div style={{ color: 'var(--danger)', fontSize: 13 }}>{quizError}</div>
        )}
      </div>
      ...
      {phase === 'idle' && !starting && (
        <div className="muted" style={{ fontSize: 13 }}>
          Choose a test type and number of questions, then start a test.
        </div>
      )}
    </div>
  )
