          ...
          <View style={{ flex: 1, justifyContent: 'center', paddingVertical: 16 }}>
            <AuthGlassCard>
              <View style={{ alignItems: 'center', marginBottom: 28 }}>
                ...
                >
                  Create your <Text style={{ color: AUTH.zinc200, fontWeight: '600' }}>GMAT Lexicon</Text> account to save and
                  practice words across web and mobile.
                </Text>
              </View>
              ...
              {error ? (
                <Text style={{ color: AUTH.danger, fontSize: 14, marginBottom: 12, fontFamily: fonts.fontBody }}>{error}</Text>
              ) : null}
              ...
              <View style={{ marginTop: 28, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ fontSize: 14, color: AUTH.zinc400, fontFamily: fonts.fontBody }}>Already have an account? </Text>
                <Pressable onPress={onGoSignIn} hitSlop={8}>
                  <Text style={{ fontSize: 14, color: AUTH.primary, fontWeight: '800', fontFamily: fonts.fontLabelBold }}>
                    Sign in
                  </Text>
                </Pressable>
              </View>
